...
import { useTeamMemberCount, useCustomerServiceRepresentativeCount, useBookingCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const customerServiceRepresentativeStat = useCustomerServiceRepresentativeCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: customerServiceRepresentativeStat?.data,
      isLoading: customerServiceRepresentativeStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Bookings',
