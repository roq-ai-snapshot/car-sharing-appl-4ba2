...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'car.count', 'customer_service_representative.count', 'team_member.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('customer_service_representative', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'customer_service_representative',
          header: 'Customer Service Representative',
          accessorKey: 'customer_service_representative',
          cell: ({ row: { original: record } }: any) => record?._count?.customer_service_representative,
        }
      : null,
