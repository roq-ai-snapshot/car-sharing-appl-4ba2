...
import { useCustomerServiceRepresentativeFindFirst, useRoqClient } from 'lib/roq';

import { CustomerServiceRepresentativeInterface } from 'interfaces/customer-service-representative';

function CustomerServiceRepresentativeViewPage() {
  ...
  const { data, error, isLoading } = useCustomerServiceRepresentativeFindFirst(queryParams, {}, { disabled: !id });
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Customer Service Representative Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess(
                  ...
                  <NextLink href={`/customer-service-representatives/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={data?.shift_start_time ? format(data?.shift_start_time, 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Shift End Time"
                  text={data?.shift_end_time ? format(data?.shift_end_time, 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Days Of Week" text={data?.days_of_week} />
...
)(CustomerServiceRepresentativeViewPage);
